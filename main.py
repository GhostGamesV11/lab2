#zad1
#lista = ["piłka nożna","siatkówka","pływanie"]

#lista.reverse()
#lista.insert(4,"tenis")
...
# if p>0:
#     p=math.sqrt(p)
#     print("Pierwiastek z tej liczby to:",p)
# elif p<0:
